<?php /* Smarty version 2.6.19, created on 2012-08-24 14:52:13
         compiled from template_admin_listing_doctor.tpl */ ?>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<a href="./admin_listing.php?action=prestations_medecins"><?php echo $this->_config[0]['vars']['navigation_title_admin_listing_prestations_medecins']; ?>
					...
					<span><?php echo $this->_config[0]['vars']['dico_admin_listing_menu_doctor']; ?>
</span> 
