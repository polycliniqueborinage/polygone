<?php /* Smarty version 2.6.19, created on 2012-09-08 09:14:08
         compiled from template_calbody.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'template_calbody.tpl', 95, false),)), $this); ?>

<table  id="timeline1" cellpadding="0" cellspacing="1" border="0" class="thecal" width="100%">

	<thead class="calhead">
		<tr>
			<th><a class="scroll_left" href = "javascript:changecalendar('user_menu.php?action=newcal&y=<?php echo $this->_tpl_vars['py']; ?>
...
');"></a></th>
 ...
 <?php echo $this->_tpl_vars['y']; ?>
			...
			<th><a class="scroll_right" href = "javascript:changecalendar('user_menu.php?action=newcal&y=<?php echo $this->_tpl_vars['ny']; ?>
...
"><a onclick="javascript:changeDay('<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['date']; ?>
','week_day');return false;" href="./user_agenda.php?action=day"><?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
</a>
				<?php else: ?>
				<td class="second" id = "<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
"><a href="./user_agenda.php?action=day" onclick="javascript:changeDay('<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['date']; ?>
','week_day');return false;"><?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
</a>
				<?php endif; ?>
			<?php else: ?>
...
"><?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['val']; ?>
			...
			<div class="calcontent">
										...
										<?php if ($this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['agendasnum'] > 0): ?>

						<a href="./user_agenda.php?action=day" onclick="javascript:changeDay('<?php echo $this->_tpl_vars['weeks'][$this->_sections['week']['index']][$this->_sections['day']['index']]['date']; ?>
','week_day');return false;">
