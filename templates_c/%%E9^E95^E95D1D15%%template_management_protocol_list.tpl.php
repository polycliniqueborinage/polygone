<?php /* Smarty version 2.6.19, created on 2012-09-14 13:05:43
         compiled from template_management_protocol_list.tpl */ ?>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
					...
					<span><?php echo $this->_config[0]['vars']['dico_management_protocol_menu_list']; ?>
</span> 
								...
								<div id="messagecookie">
									...
									<div class="table_head">
										<table id="protocollist" class="ricoLiveGrid" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td class="b" style="width:9%"><?php echo $this->_config[0]['vars']['dico_management_protocol_search_colum_action']; ?>
</td>
