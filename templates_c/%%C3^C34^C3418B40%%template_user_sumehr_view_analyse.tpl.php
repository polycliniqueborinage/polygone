<?php /* Smarty version 2.6.19, created on 2012-10-19 09:26:20
         compiled from template_user_sumehr_view_analyse.tpl */ ?>
				...
				<div class="ViewPane">
					...
					<div class="block_a" >
						...
						<div class="in">
							...
							<div class="headline">
								<h2><a href="user_sumehr.php?action=print_analyse&patient_id=<?php echo $this->_tpl_vars['patient_id']; ?>
&examen_id=<?php echo $this->_tpl_vars['examen_id']; ?>
" style="float:right"><img src="./templates/standard/img/16x16/printer.png" alt="" /></a>
