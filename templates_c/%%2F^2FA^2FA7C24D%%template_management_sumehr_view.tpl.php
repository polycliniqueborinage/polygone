<?php /* Smarty version 2.6.19, created on 2012-09-10 08:39:57
         compiled from template_management_sumehr_view.tpl */ ?>
 ...
 <?php echo $this->_tpl_vars['sumehr']['0']['patient_familyname']; ?>
							...
							<div id = "" style = "">
								...
								<div id="tab_content">
									<ul>
										<li>
											<a href="#fragment-1"><span><?php echo $this->_config[0]['vars']['dico_sumehr_management_subtab_general']; ?>
</span></a>
										</li>
									</ul>
...
-hover.png'/> <a target='_blank' href='management_sumehr.php?action=download_file&key=<?php echo $this->_tpl_vars['file']['key']; ?>
...
Ko)</a></li>
													...
													<?php if ($this->_tpl_vars['item']['datetime'] != ""): ?>
														<a href="#" class="butn_link" onclick="javascript:loadtabFromManagement(<?php echo $this->_tpl_vars['sumehr']['0']['patient_id']; ?>
...
');return false;"><span><?php echo $this->_config[0]['vars']['dico_button_view']; ?>
														...
														<a href="management_sumehr.php?action=edit&patient_id=<?php echo $this->_tpl_vars['item']['patient_id']; ?>
&user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
...
" class="butn_link"><span><?php echo $this->_config[0]['vars']['dico_button_edit']; ?>
														...
														<a onclick="javascript:deleteConfirmBox(<?php echo $this->_tpl_vars['item']['sumehr_report_id']; ?>
)" class="butn_link"><span><?php echo $this->_config[0]['vars']['dico_button_delete']; ?>
</span></a>
														<br/>
													<?php endif; ?>
										...
										<a href="management_sumehr.php?action=edit&patient_id=<?php echo $this->_tpl_vars['sumehr']['0']['patient_id']; ?>
&user_id=<?php echo $this->_tpl_vars['sumehr']['0']['user_id']; ?>
