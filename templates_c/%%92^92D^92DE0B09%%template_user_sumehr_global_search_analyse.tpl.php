<?php /* Smarty version 2.6.19, created on 2012-09-17 09:43:10
         compiled from template_user_sumehr_global_search_analyse.tpl */ ?>
...
" onkeyup="javascript:sumehrCompleteSearchAnalyseMedecin('',this.value,'',$('#doctor_search').val());" onfocus="javascript:this.select()" autocomplete="off"/>
												</div>
...
" onkeyup="javascript:sumehrCompleteSearchAnalyseMedecin('',$('#patient_search').val(),'',this.value);" onfocus="javascript:this.select()" autocomplete="off"/>
												</div>
