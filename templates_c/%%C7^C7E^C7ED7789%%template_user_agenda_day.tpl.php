<?php /* Smarty version 2.6.19, created on 2012-10-15 13:26:09
         compiled from template_user_agenda_day.tpl */ ?>
			...
			<div id="tab_panel">
				...
				<div class="ViewPane">
					...
					<div class="navigation-calendar">
						...
						<a class="thisday" href="#" onclick="javascript:changeDay('d','day');return false;" title="<?php echo $this->_config[0]['vars']['dico_user_agenda_today']; ?>
"></a>
						<a class="previousMajor" href="#" onclick="javascript:changeDay(-7,'day');return false;" title="<?php echo $this->_config[0]['vars']['dico_user_agenda_previous_week']; ?>
"></a>
						<a class="previousMinor" href="" onclick="javascript:changeDay(-1,'day');return false;" title="<?php echo $this->_config[0]['vars']['dico_user_agenda_previous_day']; ?>
"></a>
						<a class="nextMajor" href="" onclick="javascript:changeDay(7,'day');return false;" title="<?php echo $this->_config[0]['vars']['dico_user_agenda_next_week']; ?>
"></a>
						<a class="nextMinor" href="" onclick="javascript:changeDay(1,'day');return false;" title="<?php echo $this->_config[0]['vars']['dico_user_agenda_next_day']; ?>
"></a>
		  				<h2 id="title"></h2>
...
$textComment<?php echo '?>'; ?>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "template_left.tpl", 'smarty_include_vars' => array('patient_search' => 'no','template' => 'day','color_schedule1' => 'yes')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "template_right.tpl", 'smarty_include_vars' => array('calendar_day' => 'yes')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		...
		<div class="block_in_wrapper">
			<form class="main" method="post" action="#">
				<fieldset>
					...
					<div class="row">
						<label>&nbsp;</label>
						<a href="#" onclick="javascript:deleteConsultation('day');$('#agendaconfirmbox').jqmHide();" class="butn_link" id="delete"><span><?php echo $this->_config[0]['vars']['dico_user_agenda_addbox_button_del']; ?>
</span></a>
