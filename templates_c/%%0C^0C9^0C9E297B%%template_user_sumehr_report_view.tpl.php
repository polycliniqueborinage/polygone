<?php /* Smarty version 2.6.19, created on 2012-09-18 14:50:56
         compiled from template_user_sumehr_report_view.tpl */ ?>
<div class = "protocol">
...
-hover.png'/> 
				<a target='_blank' href='user_sumehr.php?action=download_file&key=<?php echo $this->_tpl_vars['file']['key']; ?>
...
Ko)</a>
				...
				<?php if ($this->_tpl_vars['file']['numberimage'] > 0): ?>
		        	<a href="user_sumehr.php?action=download_image&key=<?php echo $this->_tpl_vars['file']['key']; ?>
...
" rel="prettyPhoto[iframes]">
	        			<img width="150px" src="user_sumehr.php?action=download_image&key=<?php echo $this->_tpl_vars['file']['key']; ?>
&thumbnail=1&user_id=<?php echo $this->_tpl_vars['sumehr_report']['user_ID']; ?>
&patient_id=<?php echo $this->_tpl_vars['sumehr_report']['patient_ID']; ?>
">
	        		</a>
...
">
		...
		<?php if ($this->_tpl_vars['sumehr_report']['user_ID'] == $this->_tpl_vars['user_id']): ?>
		<a href="user_sumehr.php?action=edit&patient_id=<?php echo $this->_tpl_vars['sumehr_report']['patient_ID']; ?>
