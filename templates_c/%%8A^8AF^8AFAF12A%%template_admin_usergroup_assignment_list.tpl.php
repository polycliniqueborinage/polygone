<?php /* Smarty version 2.6.19, created on 2013-04-12 16:20:06
         compiled from template_admin_usergroup_assignment_list.tpl */ ?>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
    				...
    				<span><?php echo $this->_config[0]['vars']['navigation_title_admin_usergroup_assignment_list']; ?>
</span>
							...
							<div class="in">
								...
								<div id="messagecookie">
									...
									<div class="table_head">
										<table id="assignmentlist" class="ricoLiveGrid" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td style="width:10%"><?php echo $this->_config[0]['vars']['dico_management_patient_search_colum_action']; ?>
</td>
												<td style="width:30%"><?php echo $this->_config[0]['vars']['dico_admin_usergroup_description']; ?>
</td>
												<td style="width:30%"><?php echo $this->_config[0]['vars']['dico_admin_grh_usergroup_leader']; ?>
</td>
												<td style="width:30%"><?php echo $this->_config[0]['vars']['dico_admin_grh_usergroup_member']; ?>
</td>
											</tr>
										</table>
									</div>
		...
		<div class="block_in_wrapper">
				...
				<form class="main" method="post" action="#">
					...
					<fieldset>
						...
						<div class="row">
							<label>&nbsp;</label>
							<a href="#" onclick="javascript:deleteAssignment(id);" class="butn_link" id="delete"><span><?php echo $this->_config[0]['vars']['dico_management_debt_button_delete']; ?>
</span></a>
	...
	<script type=\'text/javascript\'>
		...
		Rico.onLoad( function() {
			var opts = {  
    			...
    			columnSpecs:  [{width:45},{filterUI:\'t\',width:250}, {filterUI:\'t\',width:250}, {filterUI:\'t\',width:250}]
		  	};
	  	
			buffer=new Rico.Buffer.AjaxSQL(\'include/js/rico/ricoXMLquery.php\', {TimeOut:0});
	
			orderGrid=new Rico.LiveGrid (\'assignmentlist\', buffer, opts);
