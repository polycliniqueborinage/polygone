<?php /* Smarty version 2.6.19, created on 2012-09-21 14:56:01
         compiled from template_management_user_list.tpl */ ?>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
	  				...
	  				<a href="./management_user.php"><?php echo $this->_config[0]['vars']['dico_management_addressbook_menu_search']; ?>
</a>
	  				<a href="./management_user.php?action=add"><?php echo $this->_config[0]['vars']['dico_management_addressbook_menu_add']; ?>
</a>
					<span><?php echo $this->_config[0]['vars']['dico_management_addressbook_menu_list']; ?>
</span> 
	...
	<script type=\'text/javascript\'>
		...
		jQuery(document).ready(function(){
        	...
        	jQuery("#colr").jqGrid({
                    ...
                    //Column Reordering
                    sortable: true,
                    url:\'management_user.php?action=json_user\',
                    datatype: \'json\', 
                    mtype: \'POST\',
                    colNames:[
                    	\''; ?>
