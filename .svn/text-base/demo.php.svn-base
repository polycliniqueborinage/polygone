	...
	<head>
		...
		<script>
			...
			$(document).ready(function() {
				...
				$("#spaceused2").progressBar({ barImage: './templates/standard/img/progressbar/progressbg_yellow.gif'} );
				$("#spaceused3").progressBar({ barImage: './templates/standard/img/progressbar/progressbg_orange.gif', showText: false} );
				$("#spaceused4").progressBar(65, { showText: false, barImage: './templates/standard/img/progressbar/progressbg_red.gif'} );
