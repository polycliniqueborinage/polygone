	...
	switch ($action) {
		...
		case "specialist_pdf":
			...
			while($data = mysql_fetch_assoc($result)) 	{
				...
				$pdf->Cell($width[4],$row_height,'% M�d.','LTB');
				$pdf->Cell($width[5],$row_height,'Cecodi','LTB');	
				$pdf->Cell($width[6],$row_height,'M�d.','LTB');
		    ...
		    $mailing_id = $mailing->add('listing','polygone','polygone@polycliniqueborinage.org','Michel Ponchon','mponchon@gmail.com',$maildate,'Impression du listing des m�decins',$mail);
