{include file="template_header.tpl" js_jquery="yes" js_jqmodal="yes" js_rico="yes" js_patient="yes"}
									...
									<div class="table_head">
										<table id="patientlist" class="ricoLiveGrid" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												...
												<td class="b" style="width:18%">{#dico_management_patient_search_colum_firstname#}</td>
												<td class="b" style="width:18%">{#dico_management_patient_search_colum_birthday#}</td>
												<td class="b" style="width:18%">{#dico_management_patient_search_colum_titulaire#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_mutuelle#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_ct1_ct2#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_tp#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_matricule#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_privatephone#}</td>
												<td class="b" style="width:12%">{#dico_management_patient_search_colum_mobilephone#}</td>
											</tr>
										</table>
									</div>
