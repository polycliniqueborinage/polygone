{include file="template_header.tpl" js_jquery="yes" js_jqmodal="yes" js_patient="yes"}
				...
				<div class="ViewPane">
						...
						<div class="block_a">
							...
							<div class="in">
								...
								<div class="headline">
									<h2><img src="./templates/standard/img/symbols/search.png" alt="{#dico_management_patient_submenu_search#}" />
										<span>{#dico_management_patient_submenu_search#}</span>
									</h2>
								</div>
								...
								<div class="block_in_wrapper">
										...
										<form class="main" method="post">
											...
											<fieldset>
												...
												<div class="row">
													<label for="name">{#dico_management_patient_search#}:</label>
													<input type="text" name="name" id="name" required="1" realname="{#dico_management_patient_search#}" onkeyup="javascript:patientCompleteSearch('',this.value);patientSimpleSearch('',this.value);" autocomplete="off" />
												</div>
									...
									<div class="table_head">
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												...
												<td class="b" style="width:19%">{#dico_management_patient_search_colum_titulaire#}</td>
		...
		<div class="block_in_wrapper">
				...
				<form class="main" method="post" action="#">
					...
					<fieldset>
						...
						{#dico_management_patient_confirme_delete_question#}
						</div>
						...
						<div class="row">
							<label>&nbsp;</label>
							<a href="#" onclick="javascript:deletePatient(patient_id);" class="butn_link" id="delete"><span>{#dico_management_debt_button_delete#}</span></a>
