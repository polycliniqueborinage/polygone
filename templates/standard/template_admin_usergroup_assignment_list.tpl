	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
    				...
    				<span>{#navigation_title_admin_usergroup_assignment_list#}</span>
									...
									<div class="table_head">
										<table id="assignmentlist" class="ricoLiveGrid" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												...
												<td style="width:30%">{#dico_admin_usergroup_description#}</td>
												<td style="width:30%">{#dico_admin_grh_usergroup_leader#}</td>
												<td style="width:30%">{#dico_admin_grh_usergroup_member#}</td>
											</tr>
										</table>
									</div>
		...
		<div class="block_in_wrapper">
				...
				<form class="main" method="post" action="#">
					...
					<fieldset>
						...
						<div class="row">
							<label>&nbsp;</label>
							<a href="#" onclick="javascript:deleteAssignment(id);" class="butn_link" id="delete"><span>{#dico_management_debt_button_delete#}</span></a>
