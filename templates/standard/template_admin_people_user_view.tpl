{include file="template_header.tpl" js_jquery132="yes" js_jquery_ui_171="no" js_ajax="no" js_user="yes" js_jqmodal="no" password_strength="no" js_jquery_validate="no"}
									...
									<form id="adduserform" class="main" method="post" action="admin_people_user.php?action=add">
										...
										<fieldset>
											...
											<div class="row">
												...
												<label>{#dico_admin_people_user_groups#}:</label>	
											...
											<table class="resume" cellpadding="0" cellspacing="0" width="100%">
												<tr>
													...
													<td class="tools" style="width:6%;">
														<a class="tool_view" href="admin_people_user.php?action=detail&amp;id={$users[user].ID}" title="{#dico_admin_people_user_detail#}"></a>
													...
													<tr valign="top">
														...
														<h2>{#projects#}</h2>
															...
															<fieldset>
																...
																<div class="row"><input type="checkbox" class="checkbox" value="{$users[user].groups[proj].ID}" id="groups{$users[user].ID}-{$users[user].groups[proj].ID}" name="groups[]" {if $users[user].groups[proj].assigned == 1}checked="checked"{/if} />
