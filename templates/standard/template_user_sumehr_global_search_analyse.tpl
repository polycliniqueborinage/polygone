{include file="template_header.tpl" js_jquery191="yes" js_ajax="yes" js_sumehr="yes"}
										...
										<form class="main" method="post" action="#">
											...
											<fieldset>
												...
												<div class="row">
													...
													<input type="text" name="patient_search" id="patient_search" realname="{#dico_sumehr_patient_search#}" onkeyup="javascript:sumehrCompleteSearchAnalyseMedecin('',this.value,'',$('#doctor_search').val());" onfocus="javascript:this.select()" autocomplete="off"/>
												</div>
											...
											<fieldset>
												...
												<div class="row">
													...
													<input type="text" name="doctor_search" id="doctor_search" realname="{#dico_sumehr_doctor_search#}" onkeyup="javascript:sumehrCompleteSearchAnalyseMedecin('',$('#patient_search').val(),'',this.value);" onfocus="javascript:this.select()" autocomplete="off"/>
												</div>
