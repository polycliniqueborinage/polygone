...
function _ofc($width, $height, $url, $use_swfobject, $base)
{
    ...
    if (!isset($open_flash_chart_seqno))
    {
        ...
        $out[] = '<script type="text/javascript" src="include/js/swfobject.js"></script>';
    }
    else
    {
    ...
    if ($use_swfobject)
    {
        ...
        $out[] = 'var so = new SWFObject("include/js/open-flash-chart.swf", "' . $obj_id . '", "' . $width . '", "' . $height . '", "9", "#d9dee8");';
    ...
    $out[] = '<param name="movie" value="include/js/open-flash-chart.swf?width=' . $width . '&height=' . $height . '&data=' . $url . '" />';
    $out[] = '<param name="quality" value="high" />';
    $out[] = '<param name="bgcolor" value="#d9dee8" />';
    $out[] = '<embed src="include/js/open-flash-chart.swf?data=' . $url . '" quality="high" bgcolor="#d9dee8" width="' . $width . '" height="' . $height . '" name="' . $obj_id . '" align="middle" allowScriptAccess="sameDomain" ';
